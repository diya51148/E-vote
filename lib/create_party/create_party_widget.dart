...
class _CreatePartyWidgetState extends State<CreatePartyWidget> {
  ...
  void initState() {
    ...
    _model.leaderTextController ??= TextEditingController();
    _model.leaderFocusNode ??= FocusNode();

    _model.yearTextController ??= TextEditingController();
    _model.yearFocusNode ??= FocusNode();

    _model.headquaterTextController ??= TextEditingController();
    _model.headquaterFocusNode ??= FocusNode();
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
              child: TextFormField(
                controller: _model.leaderTextController,
                focusNode: _model.leaderFocusNode,
                textCapitalization: TextCapitalization.words,
                obscureText: false,
                decoration: InputDecoration(
                  labelText: 'Party leader',
                  labelStyle: FlutterFlowTheme.of(context).labelMedium.override(
                        fontFamily: 'Readex Pro',
                        letterSpacing: 0.0,
                      ),
                ...
                validator:
                    _model.leaderTextControllerValidator.asValidator(context),
              ),
            ),
            Padding(
              padding: const EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
            ...
            Padding(
              padding: const EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
              child: TextFormField(
                controller: _model.headquaterTextController,
                focusNode: _model.headquaterFocusNode,
                textCapitalization: TextCapitalization.words,
                obscureText: false,
                decoration: InputDecoration(
                  labelText: 'Headquaters',
                  labelStyle: FlutterFlowTheme.of(context).labelMedium.override(
                        fontFamily: 'Readex Pro',
                        letterSpacing: 0.0,
                      ),
                ...
                validator: _model.headquaterTextControllerValidator
                    .asValidator(context),
              ),
            ),
            Padding(
            ...
            Align(
              ...
              child: Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await PartyRecord.collection
                        .doc()
                        .set(createPartyRecordData(
                          partyName: _model.yourNameTextController.text,
                          partyLeader: _model.leaderTextController.text,
                          foundedYear:
                              int.tryParse(_model.yearTextController.text),
                          headquarters: _model.headquaterTextController.text,
                          symbol: _model.uploadedFileUrl,
                          contactNumber: _model.numberTextController.text,
