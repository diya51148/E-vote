                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          'Remember, you can\'t change your vote after you submit it.',
                  ...
                  child: StreamBuilder<List<CandidatesRecord>>(
                    stream: queryCandidatesRecord(
                      queryBuilder: (candidatesRecord) =>
                          candidatesRecord.where(
                        'ElectionID',
                        isEqualTo: widget.electionId,
                      ),
                    ),
                    builder: (context, snapshot) {
                      ...
                      List<CandidatesRecord> listViewCandidatesRecordList =
                          snapshot.data!;
                        ...
                        itemBuilder: (context, listViewIndex) {
                          ...
                          return Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                if (FFAppState().CandidateId?.id !=
                                    listViewCandidatesRecord.reference.id)
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      FFAppState().CandidateId =
                                          listViewCandidatesRecord.reference;
                                      safeSetState(() {});
                                    },
                                    child: Icon(
                                  ...
                                  children: [
                                    Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          10.0, 0.0, 0.0, 0.0),
                                      child: Text(
                                        listViewCandidatesRecord.partyName,
                                ...
                                StreamBuilder<PartyRecord>(
                                  stream: PartyRecord.getDocument(
                                      listViewCandidatesRecord.partyId!),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
                                      return Center(
                        ...
                        onPressed: () async {
                          context.pushNamed(
                            ...
                            queryParameters: {
                              ...
                              'candiadetId': serializeParam(
                                FFAppState().CandidateId,
                                ParamType.DocumentReference,
                              ),
                              'voterImg': serializeParam(
                                widget.voterImg,
                                ParamType.String,
                              ),
                            }.withoutNulls,
