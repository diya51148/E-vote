...
import 'candidate_registration_model.dart';
export 'candidate_registration_model.dart';

class CandidateRegistrationWidget extends StatefulWidget {
  const CandidateRegistrationWidget({super.key});

  @override
  State<CandidateRegistrationWidget> createState() =>
      _CandidateRegistrationWidgetState();
}

class _CandidateRegistrationWidgetState
    extends State<CandidateRegistrationWidget> {
  late CandidateRegistrationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CandidateRegistrationModel());
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  StreamBuilder<List<PartyRecord>>(
                                    stream: queryPartyRecord(
                                      queryBuilder: (partyRecord) =>
                                          partyRecord.orderBy('Created_time',
                                              descending: true),
                                    ),
                                  ...
                                  StreamBuilder<List<ElectionsRecord>>(
                                    stream: queryElectionsRecord(
                                      queryBuilder: (electionsRecord) =>
                                          electionsRecord.orderBy(
                                              'Created_time',
                                              descending: true),
                                    ),
                                    builder: (context, snapshot) {
                                      ...
                                      return FlutterFlowDropDown<String>(
                                        controller: _model
                                            ...
                                            FormFieldController<String>(null),
                                        options: dropDownElectionsRecordList
                                            .map((e) => e.electionName)
                                            .toList(),
                                        onChanged: (val) => safeSetState(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        _model.partyId = await queryPartyRecordOnce(
                        ...
                        _model.electionId = await queryElectionsRecordOnce(
                          queryBuilder: (electionsRecord) =>
                              electionsRecord.where(
                            'ElectionName',
                        ...
                        await CandidatesRecord.collection
                            ...
                            .set(createCandidatesRecordData(
                              ...
                              partyName: _model.dropDownValue1,
                              contactNumber: int.tryParse(
                                  _model.phoneNumberTextController.text),
                              email: currentUserEmail,
                              partyId: _model.partyId?.reference,
                              electionID: _model.electionId?.reference,
                              candidateID: _model.uploadedFileUrl,
                            ));
